...
| 2026-07-20 ~ 07-24 | verl dynamic scheduling；NeMo RL NIXL/TRT-LLM rollout backend；AReaL HTTP scheduler and sampling-evidence validation | scheduler / rollout / control plane | 动态资源调度、流式 prompt-group 消费、pluggable refit/backend 与 sampling-evidence correctness 开始汇合，直接面向长尾 rollout 与服务化控制面 | [07-22](frontier_scan_2026-07-22.md#rl-framework-watch-historical-audit-backfill) / [07-24](frontier_scan_2026-07-24.md#rl-framework-watch) |
