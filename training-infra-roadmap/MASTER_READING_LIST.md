...
| [Frontier Scan 2026-09-16](tracking/frontier_scan_2026-09-16.md) | 最新扫描；含来源覆盖盲区与补扫起点 |
| [RL 状态边界阅读组合](reading_queue/P1.md#rl-state-boundaries-reading) | 从 partial group、checkpoint publication 到 refit admission |
| [Frontier Scan 2026-09-01](tracking/frontier_scan_2026-09-01.md) | 历史 frontier scan，覆盖到 2026-09-01 11:31:29 |
...
| [选择性重计算](topics/long_context_training.md#selective-recompute) | 保存边界、MCore 参数、Dense/MoE/MLA 模块选择、FlashAttention 后的收益重估与排障 |
...
| 32 | AReaL | [RL Framework Selection](topics/rl_framework_selection.md)；[项目 Gateway 源码审阅](topics/agentic_rl.md#project-gateway-ownership)；[面试速答](../private_resume/2026-08-llm-infra-interview-prep.md#areal-09) | 异步 rollout/train 解耦；cohort 粘性路由、session 准入、engine 负载、版本预算与团队/个人边界 |
