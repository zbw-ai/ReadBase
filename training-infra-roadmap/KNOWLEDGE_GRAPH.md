...
- [TP 的 dX/dW 与 SP 通信推导](topics/tensor_parallelism.md#tp-collective-derivation) ↔ [Ring AllReduce 四卡逐步执行](topics/nccl.md#ring-allreduce) ↔ [主文档 TP 速答](../private_resume/2026-08-llm-infra-interview-prep.md#megatron-02)
...
- [Gateway 源码机制与版本边界](topics/agentic_rl.md#project-gateway-ownership) ↔ [两层路由与 engine 负载选路](topics/agentic_rl.md#gateway-engine-routing) ↔ [面试口述与 ownership](../private_resume/2026-08-llm-infra-interview-prep.md#areal-09)
