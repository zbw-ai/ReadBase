...
**进度更新（2026-09-09）**：今天下午笔试已通过，后续请从 [Meshy 技术面专项：低精度、GPU、PyTorch 与 3D/视频](2026-09-meshy-ml-system-interview-prep.md#meshy-interview-top)开始。本页保留 NumPy/Transformer 基础练习，不把事先自拟题改写为本人笔试实题。
